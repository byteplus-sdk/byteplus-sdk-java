...
/**
 * ListVhostRecordPresetV2ResResultPresetListItemSlicePresetRecordPresetConfigFlvParam
 */
@lombok.Data
public final class ListVhostRecordPresetV2ResResultPresetListItemSlicePresetRecordPresetConfigFlvParam  {
    ...
    private ListVhostRecordPresetV2ResResultPresetListItemSlicePresetRecordPresetConfigFlvParamTOSParam tOSParam;

    /**
     * <p>VOD 存储相关配置</p>
     */
    @com.alibaba.fastjson.annotation.JSONField(name = "VODParam")
    private ListVhostRecordPresetV2ResResultPresetListItemSlicePresetRecordPresetConfigFlvParamVODParam vODParam;
