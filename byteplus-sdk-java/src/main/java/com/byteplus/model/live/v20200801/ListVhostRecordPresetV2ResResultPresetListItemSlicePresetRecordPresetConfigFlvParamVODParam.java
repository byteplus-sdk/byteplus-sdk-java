...
/**
 * ListVhostRecordPresetV2ResResultPresetListItemSlicePresetRecordPresetConfigFlvParamVODParam
 */
@lombok.Data
public final class ListVhostRecordPresetV2ResResultPresetListItemSlicePresetRecordPresetConfigFlvParamVODParam  {
    ...
    /**
     * <p>录制文件的存储位置。默认存储位置为 `record/{PubDomain}/{App}/{Stream}/{StartTime}_{EndTime}`</p>
     */
