...
public final class UpdateTranscodePresetBody  {
    ...
    /**
     * <p>视频帧率，单位为 fps，取值范围为 [0,60]，帧率越大，画面越流畅</p>
     */
    @com.alibaba.fastjson.annotation.JSONField(name = "FPS")
    private Integer fPS;

    /**
     * <p>IDR 帧之间的最大间隔，单位为 ，取值范围为 [0,1000]</p>
     */
    ...
    /**
     * <p>视频码率，单位为 bps，取值范围为 [0,30000000]；取值为 0 时，表示使用源流码率</p>
     */
