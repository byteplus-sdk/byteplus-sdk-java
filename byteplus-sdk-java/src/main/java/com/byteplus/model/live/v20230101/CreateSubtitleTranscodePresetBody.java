 ...
 */
@lombok.Data
public final class CreateSubtitleTranscodePresetBody  {
    ...
    /**
     * <p>字幕配置的名称，不可以与其他已有的配置名称重复。默认为空，表示由系统将自动分配配置名称。</p>
     */
    ...
    /**
     * <p>关联的转码配置后缀，一个字幕配置支持关联多个转码配置后缀。</p>
     */
    ...
    private CreateSubtitleTranscodePresetBodyPosition position;

    /**
     * <p>原文字幕展示参数配置。</p>
     */
    @com.alibaba.fastjson.annotation.JSONField(name = "SourceLanguage")
    private CreateSubtitleTranscodePresetBodySourceLanguage sourceLanguage;

    /**
     * <p>译文字幕展示参数配置列表，当前最多支持配置一种译文。</p>
     */
    @com.alibaba.fastjson.annotation.JSONField(name = "TargetLanguage")
    private List<CreateSubtitleTranscodePresetBodyTargetLanguageItem> targetLanguage;
