...
/**
 * DescribeLiveENMetricTrafficDataResResult
 */
@lombok.Data
public final class DescribeLiveENMetricTrafficDataResResult  {
    ...
    private List<DescribeLiveENMetricTrafficDataResResultRegionListItem> regionList;

    /**
     * <p>客户端 IP 所属区域列表。</p>
     */
    @com.alibaba.fastjson.annotation.JSONField(name = "UserRegionList")
    private List<DescribeLiveENMetricTrafficDataResResultUserRegionListItem> userRegionList;
    ...
    private List<DescribeLiveENMetricTrafficDataResResultTrafficDataListItem> trafficDataList;
    ...
    private List<DescribeLiveENMetricTrafficDataResResultTrafficDetailDataListItem> trafficDetailDataList;
