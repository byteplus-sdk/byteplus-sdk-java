...
public final class DescribeLiveLogDataResResultLogInfoListItem  {
     ...
     * <p>:::tip</p>
     *
     * <p>查询拉流转推日志（Type 取值为 `relay`）时，该字段为空。</p>
     *
     * <p>:::</p>
     */
     ...
     *
     * <p>- 与域名相关时：加速域名_年_月_日_时间开始_时间结束_文件拆分序号。例如，`push.example.com_2023_08_11_000000_010000_0.gz`；</p>
     *
    ...
    /**
     * <p>日志文件对应的小时区间，RFC3339 格式的时间戳，精度为秒。</p>
     */
