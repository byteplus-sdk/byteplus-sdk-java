...
public final class DescribeLiveTrafficDataBody  {
    ...
    /**
     * <p>域名列表，默认为空，表示查询您视频直播产品下所有域名的流量用量数据。您可以调用 [ListDomainDetail](https://www.volcengine.com/docs/6469/1126815) 接口或在视频直播控制台的[域名管理](https://console.volcengine.com/live/main/domain/list)页面，获取待查询的域名。</p>
     */
    ...
    private List<com.byteplus.model.live.v20230101.ReqRegion> userRegionList;
    ...
    /**
     * <p>数据拆分的维度，默认为空表示不按维度进行数据拆分，支持的维度如下。</p>
     *
     * <p>- `Domain`：域名；</p>
     *
     * <p>- `ISP`：运营商；</p>
    ...
    /**
     * <p>指定查询的流量数据为闲时或忙时，缺省情况下为查询全部数据，支持的取值如下。</p>
     *
     * <p>- busy：忙时；</p>
     *
     * <p>- free：闲时。</p>
     */
    @com.alibaba.fastjson.annotation.JSONField(name = "Stage")
