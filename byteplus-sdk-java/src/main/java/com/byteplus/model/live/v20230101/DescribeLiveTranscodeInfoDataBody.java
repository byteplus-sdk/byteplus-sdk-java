 ...
 */
@lombok.Data
public final class DescribeLiveTranscodeInfoDataBody  {
    ...
    /**
     * <p>转码分辨率档位，默认为空表示不指定转码分辨率档位。以 720P 为例，表示转码配置的长边 x 短边计算而出的面积大于 480P（640 × 480）且小于等于 720P 档位（1280 x 720）。支持的取值和含义如下所示。</p>
     *
     * <p>- `480P`：640 × 480；</p>
     *
     * <p>- `720P`：1280 × 720；</p>
    ...
    /**
     * <p>视频编码格式，默认为空表示不指定视频编码格式，支持的取值和含义如下所示。</p>
     *
