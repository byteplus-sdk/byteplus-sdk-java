...
/**
 * DescribeRemoteAuthResResult
 */
@lombok.Data
public final class DescribeRemoteAuthResResult  {
    ...
    private DescribeRemoteAuthResResultDenyRule denyRule;
    ...
    private DescribeRemoteAuthResResultCacheConfig cacheConfig;
    ...
    private DescribeRemoteAuthResResultQueryParamConfig queryParamConfig;

    /**
     * <p>鉴权请求 Header 参数配置。</p>
     */
    @com.alibaba.fastjson.annotation.JSONField(name = "HeaderParamConfig")
    private DescribeRemoteAuthResResultHeaderParamConfig headerParamConfig;
    ...
    private List<DescribeRemoteAuthResResultBodyParamsItem> bodyParams;
