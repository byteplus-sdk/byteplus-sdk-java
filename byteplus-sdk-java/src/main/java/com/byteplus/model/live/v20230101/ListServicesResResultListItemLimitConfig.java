...
/**
 * ListServicesResResultListItemLimitConfig
 */
@lombok.Data
public final class ListServicesResResultListItemLimitConfig  {
     ...
     * <p>TODO</p>
     */
    @com.alibaba.fastjson.annotation.JSONField(name = "PostProcessClustersEnum")
    private List<String> postProcessClustersEnum;

    /**
     * <p>TODO</p>
     */
    @com.alibaba.fastjson.annotation.JSONField(name = "PostProcessLimits")
    private List<ListServicesResResultListItemLimitConfigPostProcessLimitsItem> postProcessLimits;
