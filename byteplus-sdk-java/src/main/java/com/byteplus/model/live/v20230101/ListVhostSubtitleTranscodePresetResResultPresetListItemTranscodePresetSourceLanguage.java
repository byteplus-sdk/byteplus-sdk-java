...
/**
 * ListVhostSubtitleTranscodePresetResResultPresetListItemTranscodePresetSourceLanguage
 */
@lombok.Data
public final class ListVhostSubtitleTranscodePresetResResultPresetListItemTranscodePresetSourceLanguage  {

    /**
     * <p>原文字幕的字体描边配置。</p>
     */
    @com.alibaba.fastjson.annotation.JSONField(name = "Border")
    private ListVhostSubtitleTranscodePresetResResultPresetListItemTranscodePresetSourceLanguageBorder border;
    ...
    /**
     * <p>原文字幕的字体大小，单位为 px。</p>
     *
     * <p>:::tip</p>
     *
     * <p>- 使用预设配置时，字幕字体大小设置不生效。</p>
     *
     * <p>- 不使用预设配置时，字幕字体大小为必选参数。</p>
     *
     * <p>:::</p>
     */
