 ...
 */
@lombok.Data
public final class UpdateRemoteAuthBody  {
    ...
    /**
     * <p>自定义的远程鉴权请求路径，`UseUserRequest` 设置为 `false`时必填。</p>
     */
    ...
    /**
     * <p>单次鉴权请求超时时长，默认为 `1`，单位为秒，取值范围为[0, 600]。</p>
     */
    ...
    private UpdateRemoteAuthBodyDenyRule denyRule;
    ...
    private UpdateRemoteAuthBodyCacheConfig cacheConfig;
    ...
    private UpdateRemoteAuthBodyQueryParamConfig queryParamConfig;

    /**
     * <p>鉴权请求 Header 参数配置。</p>
     */
    @com.alibaba.fastjson.annotation.JSONField(name = "HeaderParamConfig")
    private UpdateRemoteAuthBodyHeaderParamConfig headerParamConfig;
    ...
    private List<UpdateRemoteAuthBodyBodyParamsItem> bodyParams;
