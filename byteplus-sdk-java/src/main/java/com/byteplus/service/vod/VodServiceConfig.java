    ...
    public static Map<String, ServiceInfo> ServiceInfoMap = new HashMap<String, ServiceInfo>() {
        {
            ...
            put(com.byteplus.helper.Const.REGION_AP_SOUTHEAST_1, new ServiceInfo(
                    new HashMap<String, Object>() {
                        {
                            put(com.byteplus.helper.Const.CONNECTION_TIMEOUT, 5000);
                            put(com.byteplus.helper.Const.SOCKET_TIMEOUT, 5000);
                            ...
                            put(com.byteplus.helper.Const.Credentials, new Credentials(com.byteplus.helper.Const.REGION_AP_SOUTHEAST_1, "vod"));
                        }
                    }
            ));
        }
...
//            ));
    ...
    public static Map<String, ApiInfo> apiInfoListApSoutheast1 = new HashMap<String, ApiInfo>() {
        {
            // **********************************************************************
            // 播放
            // **********************************************************************
