...
public class VodServiceImpl extends com.byteplus.service.BaseServiceImpl implements com.byteplus.service.vod.IVodService {
	...
	protected VodServiceImpl() {
        super(com.byteplus.service.vod.VodConfig.ServiceInfoMap.get(com.byteplus.helper.Const.REGION_AP_SINGAPORE_1), com.byteplus.service.vod.VodConfig.apiInfoList);
    }

    private VodServiceImpl(com.byteplus.model.ServiceInfo serviceInfo) {
        super(serviceInfo, com.byteplus.service.vod.VodConfig.apiInfoList);
    }
    ...
    public static com.byteplus.service.vod.IVodService getInstance(String region) throws Exception {
        com.byteplus.model.ServiceInfo serviceInfo = com.byteplus.service.vod.VodConfig.ServiceInfoMap.get(region);
        if (serviceInfo == null) {
    ...
    public String createSha1HlsDrmAuthToken(Long expireSeconds) throws Exception {
        return createHlsDrmAuthToken(com.byteplus.helper.Const.DSAHmacSha1, expireSeconds);
    }
    ...
    public String createHlsDrmAuthToken(String dsa, Long expireSeconds) throws Exception {
        ...
        return getSignUrl(com.byteplus.helper.Const.GetHlsDecryptionKey, com.byteplus.helper.Utils.mapToPairList(params));
    }
    ...
    private String createAuth(String dsa, long expireSeconds) throws Exception {
        ...
        String sign = "";
        switch (dsa) {
            case com.byteplus.helper.Const.DSAHmacSha1:
                ...
                break;
            case com.byteplus.helper.Const.DSAHmacSha256:
    ...
    public String getPlayAuthToken(com.byteplus.service.vod.model.request.VodGetPlayInfoRequest input, Long expireSeconds) throws Exception {
        ...
        String getPlayInfoToken = getSignUrl(com.byteplus.helper.Const.GetPlayInfo, com.byteplus.helper.Utils.mapToPairList(params));
        Map<String, String> ret = new HashMap<>();
    ...
    @Override
    public com.byteplus.service.vod.model.response.VodCommitUploadInfoResponse uploadMedia(com.byteplus.service.vod.model.request.VodUploadMediaRequest vodUploadMediaRequest) throws Exception {
        com.byteplus.model.beans.UploadCompleteInfo uploadCompleteInfo = uploadToB(vodUploadMediaRequest.getSpaceName(), vodUploadMediaRequest.getFilePath(), "media");
    ...
    private com.byteplus.model.beans.UploadCompleteInfo uploadToB(String spaceName, String filePath, String fileType) throws Exception {
        ...
        if (file.length() < com.byteplus.helper.Const.MinChunkSize) {
            directUpload(host, oid, auth, file, retryer);
        } else {
            boolean isLargeFile = false;
            if (file.length() > com.byteplus.helper.Const.LargeFileSize) {
                isLargeFile = true;
            }
    ...
    private void chunkUpload(String host, String oid, String auth, File file, boolean isLargeFile, Retryer retryer) throws Exception {
        ...
        byte[] data = new byte[com.byteplus.helper.Const.MinChunkSize];
        List<String> parts = new ArrayList<>();
        long num = file.length() / com.byteplus.helper.Const.MinChunkSize;
        long lastNum = num - 1;
        try (BufferedInputStream bis = new BufferedInputStream(new FileInputStream(file))) {
            ...
            long readCount = (long) com.byteplus.helper.Const.MinChunkSize * lastNum;
    ...
    @Override
    public com.byteplus.service.vod.model.response.VodCommitUploadInfoResponse uploadMaterial(com.byteplus.service.vod.model.request.VodUploadMaterialRequest vodUploadMaterialRequest) throws Exception {
        com.byteplus.model.beans.UploadCompleteInfo uploadCompleteInfo = uploadToB(vodUploadMaterialRequest.getSpaceName(), vodUploadMaterialRequest.getFilePath(), vodUploadMaterialRequest.getFileType());
	...
	public com.byteplus.service.vod.model.response.VodGetPlayInfoResponse getPlayInfo(com.byteplus.service.vod.model.request.VodGetPlayInfoRequest input) throws Exception {
		com.byteplus.model.response.RawResponse response = query(com.byteplus.helper.Const.GetPlayInfo, com.byteplus.helper.Utils.mapToPairList(com.byteplus.helper.Utils.protoBufferToMap(input, true)));
	...
	public com.byteplus.service.vod.model.response.VodGetPrivateDrmPlayAuthResponse getPrivateDrmPlayAuth(com.byteplus.service.vod.model.request.VodGetPrivateDrmPlayAuthRequest input) throws Exception {
		com.byteplus.model.response.RawResponse response = query(com.byteplus.helper.Const.GetPrivateDrmPlayAuth, com.byteplus.helper.Utils.mapToPairList(com.byteplus.helper.Utils.protoBufferToMap(input, true)));
        if (response.getCode() != com.byteplus.error.SdkError.SUCCESS.getNumber()) {
            throw response.getException();
        }
	...
	public com.byteplus.service.vod.model.response.VodGetHlsDecryptionKeyResponse getHlsDecryptionKey(com.byteplus.service.vod.model.request.VodGetHlsDecryptionKeyRequest input) throws Exception {
		com.byteplus.model.response.RawResponse response = query(com.byteplus.helper.Const.GetHlsDecryptionKey, com.byteplus.helper.Utils.mapToPairList(com.byteplus.helper.Utils.protoBufferToMap(input, true)));
        if (response.getCode() != com.byteplus.error.SdkError.SUCCESS.getNumber()) {
            throw response.getException();
        }
	...
	public com.byteplus.service.vod.model.response.VodUrlUploadResponse uploadMediaByUrl(com.byteplus.service.vod.model.request.VodUrlUploadRequest input) throws Exception {
		com.byteplus.model.response.RawResponse response = query(com.byteplus.helper.Const.UploadMediaByUrl, com.byteplus.helper.Utils.mapToPairList(com.byteplus.helper.Utils.protoBufferToMap(input, true)));
        if (response.getCode() != com.byteplus.error.SdkError.SUCCESS.getNumber()) {
            throw response.getException();
        }
	...
	public com.byteplus.service.vod.model.response.VodQueryUploadTaskInfoResponse queryUploadTaskInfo(com.byteplus.service.vod.model.request.VodQueryUploadTaskInfoRequest input) throws Exception {
		com.byteplus.model.response.RawResponse response = query(com.byteplus.helper.Const.QueryUploadTaskInfo, com.byteplus.helper.Utils.mapToPairList(com.byteplus.helper.Utils.protoBufferToMap(input, true)));
        if (response.getCode() != com.byteplus.error.SdkError.SUCCESS.getNumber()) {
            throw response.getException();
        }
	...
	public com.byteplus.service.vod.model.response.VodApplyUploadInfoResponse applyUploadInfo(com.byteplus.service.vod.model.request.VodApplyUploadInfoRequest input) throws Exception {
		com.byteplus.model.response.RawResponse response = query(com.byteplus.helper.Const.ApplyUploadInfo, com.byteplus.helper.Utils.mapToPairList(com.byteplus.helper.Utils.protoBufferToMap(input, true)));
        if (response.getCode() != com.byteplus.error.SdkError.SUCCESS.getNumber()) {
            throw response.getException();
        }
	...
	public com.byteplus.service.vod.model.response.VodCommitUploadInfoResponse commitUploadInfo(com.byteplus.service.vod.model.request.VodCommitUploadInfoRequest input) throws Exception {
		com.byteplus.model.response.RawResponse response = query(com.byteplus.helper.Const.CommitUploadInfo, com.byteplus.helper.Utils.mapToPairList(com.byteplus.helper.Utils.protoBufferToMap(input, true)));
        if (response.getCode() != com.byteplus.error.SdkError.SUCCESS.getNumber()) {
            throw response.getException();
        }
	...
	public com.byteplus.service.vod.model.response.VodUpdateMediaInfoResponse updateMediaInfo(com.byteplus.service.vod.model.request.VodUpdateMediaInfoRequest input) throws Exception {
		com.byteplus.model.response.RawResponse response = query(com.byteplus.helper.Const.UpdateMediaInfo, com.byteplus.helper.Utils.mapToPairList(com.byteplus.helper.Utils.protoBufferToMap(input, true)));
        if (response.getCode() != com.byteplus.error.SdkError.SUCCESS.getNumber()) {
            throw response.getException();
        }
	...
	public com.byteplus.service.vod.model.response.VodUpdateMediaPublishStatusResponse updateMediaPublishStatus(com.byteplus.service.vod.model.request.VodUpdateMediaPublishStatusRequest input) throws Exception {
		com.byteplus.model.response.RawResponse response = query(com.byteplus.helper.Const.UpdateMediaPublishStatus, com.byteplus.helper.Utils.mapToPairList(com.byteplus.helper.Utils.protoBufferToMap(input, true)));
        if (response.getCode() != com.byteplus.error.SdkError.SUCCESS.getNumber()) {
            throw response.getException();
        }
	...
	public com.byteplus.service.vod.model.response.VodGetMediaInfosResponse getMediaInfos(com.byteplus.service.vod.model.request.VodGetMediaInfosRequest input) throws Exception {
		com.byteplus.model.response.RawResponse response = query(com.byteplus.helper.Const.GetMediaInfos, com.byteplus.helper.Utils.mapToPairList(com.byteplus.helper.Utils.protoBufferToMap(input, true)));
        if (response.getCode() != com.byteplus.error.SdkError.SUCCESS.getNumber()) {
            throw response.getException();
        }
	...
	public com.byteplus.service.vod.model.response.VodDeleteMediaResponse deleteMedia(com.byteplus.service.vod.model.request.VodDeleteMediaRequest input) throws Exception {
		com.byteplus.model.response.RawResponse response = query(com.byteplus.helper.Const.DeleteMedia, com.byteplus.helper.Utils.mapToPairList(com.byteplus.helper.Utils.protoBufferToMap(input, true)));
        if (response.getCode() != com.byteplus.error.SdkError.SUCCESS.getNumber()) {
            throw response.getException();
        }
	...
	public com.byteplus.service.vod.model.response.VodDeleteTranscodesResponse deleteTranscodes(com.byteplus.service.vod.model.request.VodDeleteTranscodesRequest input) throws Exception {
		com.byteplus.model.response.RawResponse response = query(com.byteplus.helper.Const.DeleteTranscodes, com.byteplus.helper.Utils.mapToPairList(com.byteplus.helper.Utils.protoBufferToMap(input, true)));
        if (response.getCode() != com.byteplus.error.SdkError.SUCCESS.getNumber()) {
            throw response.getException();
        }
	...
	public com.byteplus.service.vod.model.response.VodGetMediaListResponse getMediaList(com.byteplus.service.vod.model.request.VodGetMediaListRequest input) throws Exception {
		com.byteplus.model.response.RawResponse response = query(com.byteplus.helper.Const.GetMediaList, com.byteplus.helper.Utils.mapToPairList(com.byteplus.helper.Utils.protoBufferToMap(input, true)));
        if (response.getCode() != com.byteplus.error.SdkError.SUCCESS.getNumber()) {
            throw response.getException();
        }
	...
	public com.byteplus.service.vod.model.response.VodStartWorkflowResponse StartWorkflow(com.byteplus.service.vod.model.request.VodStartWorkflowRequest input) throws Exception {
		com.byteplus.model.response.RawResponse response = query(com.byteplus.helper.Const.StartWorkflow, com.byteplus.helper.Utils.mapToPairList(com.byteplus.helper.Utils.protoBufferToMap(input, true)));
        if (response.getCode() != com.byteplus.error.SdkError.SUCCESS.getNumber()) {
            throw response.getException();
        }
