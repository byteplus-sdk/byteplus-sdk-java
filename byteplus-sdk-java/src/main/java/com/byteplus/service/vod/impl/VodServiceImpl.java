...
public class VodServiceImpl extends com.byteplus.service.BaseServiceImpl implements com.byteplus.service.vod.IVodService {
    ...
    private void parseM3U8ManifestRecursive(String spaceName, String currentPath, String relativePathPrefix,
        ...
        com.byteplus.service.vod.model.request.VodParseUploadManifestRequest req =
                com.byteplus.service.vod.model.request.VodParseUploadManifestRequest.newBuilder()
                        .setSpaceName(spaceName)
                        .setManifestType("m3u8")
                        .setManifestContent(manifestContent)
                        .build();

        com.byteplus.service.vod.model.response.VodParseUploadManifestResponse resp = parseUploadManifest(req);
    ...
    private void uploadM3U8Segments(com.byteplus.service.vod.model.request.VodUploadMediaRequest vodUploadMediaRequest,
                                    List<M3U8SegmentInfo> segments,
                                    Map<String, Long> fileSizeMap,
                                    com.byteplus.helper.VodUploadProgressListener listener) throws Exception {
        ...
        for (M3U8SegmentInfo segment : segments) {
            ...
            com.byteplus.service.vod.model.request.VodUploadMediaRequest.Builder builder =
                    com.byteplus.service.vod.model.request.VodUploadMediaRequest.newBuilder()
                            .setSpaceName(vodUploadMediaRequest.getSpaceName())
                            .setFilePath(segment.filePath)
                            .setFileName(segmentFileName)
                            .setFileExtension(fileExt);
            com.byteplus.service.vod.model.response.VodCommitUploadInfoResponse uploadResponse = null;
            int retryCount = 3;
            ...
            com.byteplus.helper.VodUploadProgressListenerHelper.sendVodUploadEvent(listener,
                    com.byteplus.helper.VodUploadProgressEventType.UPLOAD_BYTES_EVENT,
     ...
     */
    @Override
    public com.byteplus.service.vod.model.response.VodParseUploadManifestResponse parseUploadManifest(com.byteplus.service.vod.model.request.VodParseUploadManifestRequest input) throws Exception {
        com.byteplus.model.response.RawResponse response = json(com.byteplus.service.vod.Const.ParseUploadManifest, new ArrayList<>(), JsonFormat.printer().print(input));
        if (response.getCode() != com.byteplus.error.SdkError.SUCCESS.getNumber()) {
            throw response.getException();
        }
        com.byteplus.service.vod.model.response.VodParseUploadManifestResponse.Builder responseBuilder = com.byteplus.service.vod.model.response.VodParseUploadManifestResponse.newBuilder();
        JsonFormat.parser().ignoringUnknownFields().merge(new InputStreamReader(new ByteArrayInputStream(response.getData())), responseBuilder);
        return responseBuilder.build();
    }
     ...
     * listCdnTopAccess.
     *
     * @param input com.byteplus.service.vod.model.request.VodListCdnTopAccessRequest
     * @return com.byteplus.service.vod.model.response.VodListCdnTopAccessResponse
     * @throws Exception the exception
     */
    @Override
    public com.byteplus.service.vod.model.response.VodListCdnTopAccessResponse listCdnTopAccess(com.byteplus.service.vod.model.request.VodListCdnTopAccessRequest input) throws Exception {
        com.byteplus.model.response.RawResponse response = query(com.byteplus.service.vod.Const.ListCdnTopAccess, com.byteplus.helper.Utils.mapToPairList(com.byteplus.helper.Utils.protoBufferToMap(input, true)));
        if (response.getCode() != com.byteplus.error.SdkError.SUCCESS.getNumber()) {
            throw response.getException();
        }
        com.byteplus.service.vod.model.response.VodListCdnTopAccessResponse.Builder responseBuilder = com.byteplus.service.vod.model.response.VodListCdnTopAccessResponse.newBuilder();
        JsonFormat.parser().ignoringUnknownFields().merge(new InputStreamReader(new ByteArrayInputStream(response.getData())), responseBuilder);
        return responseBuilder.build();
    }
