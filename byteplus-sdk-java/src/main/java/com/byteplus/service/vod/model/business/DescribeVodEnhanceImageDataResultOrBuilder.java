...
public interface DescribeVodEnhanceImageDataResultOrBuilder extends
    // @@protoc_insertion_point(interface_extends:Byteplus.Vod.Models.Business.DescribeVodEnhanceImageDataResult)
   ...
   */
  java.util.List<com.byteplus.service.vod.model.business.DescribeVodEnhanceImageDataItem> 
      getEnhanceImageListList();
  /**
   * <code>repeated .Byteplus.Vod.Models.Business.DescribeVodEnhanceImageDataItem EnhanceImageList = 9;</code>
   */
  com.byteplus.service.vod.model.business.DescribeVodEnhanceImageDataItem getEnhanceImageList(int index);
  /**
   * <code>repeated .Byteplus.Vod.Models.Business.DescribeVodEnhanceImageDataItem EnhanceImageList = 9;</code>
   */
   ...
   * <code>repeated .Byteplus.Vod.Models.Business.DescribeVodEnhanceImageDataItem EnhanceImageList = 9;</code>
   */
  java.util.List<? extends com.byteplus.service.vod.model.business.DescribeVodEnhanceImageDataItemOrBuilder> 
      getEnhanceImageListOrBuilderList();
  /**
   * <code>repeated .Byteplus.Vod.Models.Business.DescribeVodEnhanceImageDataItem EnhanceImageList = 9;</code>
   */
  com.byteplus.service.vod.model.business.DescribeVodEnhanceImageDataItemOrBuilder getEnhanceImageListOrBuilder(
      int index);
}
