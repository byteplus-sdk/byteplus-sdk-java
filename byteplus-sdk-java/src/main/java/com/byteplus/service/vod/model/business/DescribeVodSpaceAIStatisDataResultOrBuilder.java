...
public interface DescribeVodSpaceAIStatisDataResultOrBuilder extends
    // @@protoc_insertion_point(interface_extends:Byteplus.Vod.Models.Business.DescribeVodSpaceAIStatisDataResult)
   ...
   */
  java.util.List<com.byteplus.service.vod.model.business.DescribeVodSpaceAIStatisDataDetail> 
      getAiUsageDataDetailListList();
  /**
   * <code>repeated .Byteplus.Vod.Models.Business.DescribeVodSpaceAIStatisDataDetail AiUsageDataDetailList = 10;</code>
   */
  com.byteplus.service.vod.model.business.DescribeVodSpaceAIStatisDataDetail getAiUsageDataDetailList(int index);
  /**
   * <code>repeated .Byteplus.Vod.Models.Business.DescribeVodSpaceAIStatisDataDetail AiUsageDataDetailList = 10;</code>
   */
  int getAiUsageDataDetailListCount();
  /**
   * <code>repeated .Byteplus.Vod.Models.Business.DescribeVodSpaceAIStatisDataDetail AiUsageDataDetailList = 10;</code>
   */
  java.util.List<? extends com.byteplus.service.vod.model.business.DescribeVodSpaceAIStatisDataDetailOrBuilder> 
      getAiUsageDataDetailListOrBuilderList();
  /**
   * <code>repeated .Byteplus.Vod.Models.Business.DescribeVodSpaceAIStatisDataDetail AiUsageDataDetailList = 10;</code>
   */
  com.byteplus.service.vod.model.business.DescribeVodSpaceAIStatisDataDetailOrBuilder getAiUsageDataDetailListOrBuilder(
      int index);
}
