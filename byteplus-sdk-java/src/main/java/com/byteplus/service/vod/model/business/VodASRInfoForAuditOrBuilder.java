...
public interface VodASRInfoForAuditOrBuilder extends
   ...
   */
  java.util.List<com.byteplus.service.vod.model.business.VodASRUtteranceForAudit> 
      getUtterancesList();
  /**
   * <pre>
   * 识别结果语音分句信息
   ...
   */
  java.util.List<com.byteplus.service.vod.model.business.VodASRLanguageDetailForAudit> 
