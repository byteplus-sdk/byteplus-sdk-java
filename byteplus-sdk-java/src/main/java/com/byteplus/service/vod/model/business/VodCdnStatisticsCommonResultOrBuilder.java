...
public interface VodCdnStatisticsCommonResultOrBuilder extends
    // @@protoc_insertion_point(interface_extends:Byteplus.Vod.Models.Business.VodCdnStatisticsCommonResult)
    com.google.protobuf.MessageOrBuilder {

  /**
   * <code>repeated .Byteplus.Vod.Models.Business.VodCdnStatisticsData Datas = 1;</code>
   */
  java.util.List<com.byteplus.service.vod.model.business.VodCdnStatisticsData> 
      getDatasList();
  /**
   * <code>repeated .Byteplus.Vod.Models.Business.VodCdnStatisticsData Datas = 1;</code>
   */
  com.byteplus.service.vod.model.business.VodCdnStatisticsData getDatas(int index);
  /**
   * <code>repeated .Byteplus.Vod.Models.Business.VodCdnStatisticsData Datas = 1;</code>
   */
  int getDatasCount();
   ...
   * <code>repeated .Byteplus.Vod.Models.Business.VodCdnStatisticsData Datas = 1;</code>
   */
  java.util.List<? extends com.byteplus.service.vod.model.business.VodCdnStatisticsDataOrBuilder> 
      getDatasOrBuilderList();
  /**
   * <code>repeated .Byteplus.Vod.Models.Business.VodCdnStatisticsData Datas = 1;</code>
   */
  com.byteplus.service.vod.model.business.VodCdnStatisticsDataOrBuilder getDatasOrBuilder(
      int index);
