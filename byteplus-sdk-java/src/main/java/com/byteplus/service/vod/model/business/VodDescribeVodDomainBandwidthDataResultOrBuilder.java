...
public interface VodDescribeVodDomainBandwidthDataResultOrBuilder extends
    // @@protoc_insertion_point(interface_extends:Byteplus.Vod.Models.Business.VodDescribeVodDomainBandwidthDataResult)
   ...
   */
  java.util.List<com.byteplus.service.vod.model.business.VodBandwidthData> 
   ...
   * <code>repeated .Byteplus.Vod.Models.Business.VodBandwidthData BandwidthDataList = 8;</code>
   */
  com.byteplus.service.vod.model.business.VodBandwidthData getBandwidthDataList(int index);
  /**
   * <pre>
   * 所有时间粒度数据
   * </pre>
   ...
   * <code>repeated .Byteplus.Vod.Models.Business.VodBandwidthData BandwidthDataList = 8;</code>
   */
  java.util.List<? extends com.byteplus.service.vod.model.business.VodBandwidthDataOrBuilder> 
   ...
   * <code>repeated .Byteplus.Vod.Models.Business.VodBandwidthData BandwidthDataList = 8;</code>
   */
  com.byteplus.service.vod.model.business.VodBandwidthDataOrBuilder getBandwidthDataListOrBuilder(
      int index);
}
