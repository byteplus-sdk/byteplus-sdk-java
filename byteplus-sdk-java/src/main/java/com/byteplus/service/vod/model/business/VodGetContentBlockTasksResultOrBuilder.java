...
public interface VodGetContentBlockTasksResultOrBuilder extends
   ...
   */
  java.util.List<com.byteplus.service.vod.model.business.ContentTask> 
      getDataList();
  /**
   * <pre>
   *符合条件的任务结构体
   ...
   * <code>repeated .Byteplus.Vod.Models.Business.ContentTask Data = 4;</code>
   */
  com.byteplus.service.vod.model.business.ContentTask getData(int index);
  /**
   * <pre>
   *符合条件的任务结构体
   * </pre>
   ...
   * <code>repeated .Byteplus.Vod.Models.Business.ContentTask Data = 4;</code>
   */
  java.util.List<? extends com.byteplus.service.vod.model.business.ContentTaskOrBuilder> 
   ...
   * <code>repeated .Byteplus.Vod.Models.Business.ContentTask Data = 4;</code>
   */
  com.byteplus.service.vod.model.business.ContentTaskOrBuilder getDataOrBuilder(
      int index);
}
