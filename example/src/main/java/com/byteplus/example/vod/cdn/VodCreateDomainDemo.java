...
public class VodCreateDomainDemo {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            com.byteplus.service.vod.model.request.VodCreateDomainV2Request.Builder reqBuilder = com.byteplus.service.vod.model.request.VodCreateDomainV2Request.newBuilder();
            ...
            com.byteplus.service.vod.model.response.VodCreateDomainV2Response resp = vodService.createDomain(reqBuilder.build());
