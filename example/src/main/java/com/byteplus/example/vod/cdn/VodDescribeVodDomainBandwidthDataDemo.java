...
public class VodDescribeVodDomainBandwidthDataDemo {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            com.byteplus.service.vod.model.request.VodDescribeVodDomainBandwidthDataRequest.Builder reqBuilder = com.byteplus.service.vod.model.request.VodDescribeVodDomainBandwidthDataRequest.newBuilder();
            ...
            com.byteplus.service.vod.model.response.VodDescribeVodDomainBandwidthDataResponse resp = vodService.describeVodDomainBandwidthData(reqBuilder.build());
