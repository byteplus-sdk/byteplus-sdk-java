...
public class VodListCdnTasksDemo {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            com.byteplus.service.vod.model.request.VodListCdnTasksRequest.Builder reqBuilder = com.byteplus.service.vod.model.request.VodListCdnTasksRequest.newBuilder();
            ...
            com.byteplus.service.vod.model.response.VodListCdnTasksResponse resp = vodService.listCdnTasks(reqBuilder.build());
