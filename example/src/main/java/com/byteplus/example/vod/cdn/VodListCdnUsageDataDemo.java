...
public class VodListCdnUsageDataDemo {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            com.byteplus.service.vod.model.request.VodListCdnUsageDataRequest.Builder reqBuilder = com.byteplus.service.vod.model.request.VodListCdnUsageDataRequest.newBuilder();
            ...
            com.byteplus.service.vod.model.response.VodCdnStatisticsCommonResponse resp = vodService.listCdnUsageData(reqBuilder.build());
