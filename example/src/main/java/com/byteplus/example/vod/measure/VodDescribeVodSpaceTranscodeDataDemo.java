...
public class VodDescribeVodSpaceTranscodeDataDemo {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            com.byteplus.service.vod.model.request.DescribeVodSpaceTranscodeDataRequest.Builder reqBuilder = com.byteplus.service.vod.model.request.DescribeVodSpaceTranscodeDataRequest.newBuilder();
            ...
            com.byteplus.service.vod.model.response.DescribeVodSpaceTranscodeDataResponse resp = vodService.describeVodSpaceTranscodeData(reqBuilder.build());
