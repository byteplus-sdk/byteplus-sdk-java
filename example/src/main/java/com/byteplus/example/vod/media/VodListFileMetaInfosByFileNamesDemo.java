...
public class VodListFileMetaInfosByFileNamesDemo {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            com.byteplus.service.vod.model.request.VodListFileMetaInfosByFileNamesRequest.Builder reqBuilder = com.byteplus.service.vod.model.request.VodListFileMetaInfosByFileNamesRequest.newBuilder();
            ...
            com.byteplus.service.vod.model.response.VodListFileMetaInfosByFileNamesResponse resp = vodService.listFileMetaInfosByFileNames(reqBuilder.build());
