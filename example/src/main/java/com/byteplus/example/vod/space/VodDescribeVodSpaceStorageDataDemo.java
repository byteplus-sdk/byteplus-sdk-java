...
public class VodDescribeVodSpaceStorageDataDemo {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            com.byteplus.service.vod.model.request.VodDescribeVodSpaceStorageDataRequest.Builder reqBuilder = com.byteplus.service.vod.model.request.VodDescribeVodSpaceStorageDataRequest.newBuilder();
            ...
            com.byteplus.service.vod.model.response.VodDescribeVodSpaceStorageDataResponse resp = vodService.describeVodSpaceStorageData(reqBuilder.build());
